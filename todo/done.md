...
[x] install the Phaser Editor v5 MCP for yourself to use: https://lobehub.com/mcp/phaserjs-editor-mcp-server, https://github.com/phaserjs/editor-mcp-server
...
[x] Consider setting up and using these tools (Vite already in use, Phaser Editor MCP configured, Tiled/TexturePacker/Aseprite are desktop GUI tools for user to install)